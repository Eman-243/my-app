...
export default function Component() {
  ...
  return (
    <div className="mx-auto my-8 max-w-6xl font-sans">
      <div className="text-3xl font-bold mb-6">Shop with us!</div>
          ...
          <div key={index} className="relative overflow-hidden group rounded shadow-md">
            <div className="flex flex-col border border-gray-200">
              <video 
                ...
                muted
              />
              <button className="bg-white text-black text-xl font-semibold py-2 px-4 rounded hover:bg-[#F9B823] hover:text-white">
                {buttonNames[index]}
              </button>
            </div>
          </div>
