...
export default function Component() {
    return (
        <div className="max-w-6xl mb-4 font-latolight mx-auto flex items-center justify-center flex-col">
            ...
            <div className="my-8">
                <h2 className="text-3xl text-center font-bold text-[#F9B823]">
                        Nexcel Bahrain Overview
                    </h2>
                    <p className="text-center text-[18px] mt-2 leading-[1.6] items-center  text-pretty  text-gray-500 font-latolight" >
