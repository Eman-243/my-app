...
export default function Profile() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-5xl max-h-full min-h-screen bg-zinc-100 shadow-md rounded-sm font-sans tablet:ml-2 mt-2 flex-shrink-0 flex-grow py-4 px-4">
  ...
  return (
    <div className="max-w-5xl h-80 max-h-dvh bg-zinc-100 shadow-md rounded-sm font-sans tablet:ml-2 mt-2 content-center px-4">
