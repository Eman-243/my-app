...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="w-full max-w-6xl miniphone:w-full mx-auto py-2 box-content tablet:grid grid-cols-12 max-h-min mb-10">
            <div className="col-span-2 w-full h-full miniphone:hidden tablet:flex">
                <Sidebar />
            </div>
