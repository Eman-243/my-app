...
export default function ServicePage() {
  ...
  return (
    ...
    <div style={{ backgroundImage: 'url("/services/back5.png")'}}>
      ...
      <div className='relative'>
        ...
        <div className='absolute top-0 left-0 w-full h-full flex items-center p-4'>
            <div className='max-w-md ml-2'>
              <h1 className='text-white text-5xl font-bold mb-2 '>{service.title}</h1>
              <h2 className='text-white text-xl'>{service.subtitle}</h2>
          </div>
        </div>
      </div>
      ...
      <div className=' mb-8'>
        <h1 className='text-black text-3xl font-bold mb-1 text-center'>{service.title} </h1>
